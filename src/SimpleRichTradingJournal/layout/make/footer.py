...
_style_footer_col = {"display": "inline-block", "width": "25%"}
_style_col_table = {
    "width": "100%",
}
                                ...
                                [
                                    ...
                                    html.Tr(
                                        [
                                            html.Th("Money"),
                                            html.Td(
                                                f"{lc.sum_deposits - lc.sum_payouts:,.2f}", style={"textAlign": "end"}
                                            ),
                                        ],
                            ...
                            html.Tbody(
                                [
                                    html.Tr(
                                        [
                                            html.Th("-avg"),
                                            html.Th("performance", style={"textAlign": "end"}),
                                            html.Th("profit", style={"textAlign": "end"}),
                                        ],
                                        style={"borderBottom": "3px double"},
                                    ),
                                    html.Tr(
                                    ...
                                    html.Tr(
                                        [
                                            html.Th("Hold Time"),
                                            html.Td(
                                                durationformat(lc.holdtime_of_fin_trades_avg),
                ...
                [
                    html.Table(
                        [
                            html.Tbody(
                                [
                                    html.Tr([html.Th(), html.Th("$"), html.Th("Current %"), html.Th("Dripping %")]),
                                    html.Tr(
                                        [
                                            html.Th("Profits"),
                                    ...
                                    html.Tr(
                                        [
                                            ...
                                            html.Td(
                                                f"{lc.current_summary_rate:,.2%}", style={"borderTop": "1px solid"}
                                            ),
