...
if len(_notes_) == 1:
    ...
    _note_ = _default_col_def | {"headerName": "Notes", "children": _notes_}
...
_columns_ = [
    ...
    | {
        "headerName": "Asset",
        "children": [
            _default_col_def | {"field": "cat", "hide": not __ini__.cmdl.FLAGS.debug, "width": 50},
            _default_col_def | {"field": "id", "hide": not __ini__.cmdl.FLAGS.debug, "width": 50},
            _default_col_def | {"field": "mark", "hide": not __ini__.cmdl.FLAGS.debug, "width": 50},
            *_asset_ids1_,
        ],
    },
    _default_col_def | {"headerName": "", "children": _asset_ids2_},
    _default_col_def
    | {
        "headerName": "Invest",
        "children": [
