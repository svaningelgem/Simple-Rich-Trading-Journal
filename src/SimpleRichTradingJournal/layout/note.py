            ...
            [
                html.Div(
                    [
                        ...
                        noteeditor_file_request_msg := html.Span(
                            id="noteeditor_file_request_msg_", style={"fontStyle": "italic", "fontWeight": "bold"}
                        ),
                ...
                noteeditor_file_request_rn := html.Button(
                    [
                        html.Span("create "),
                        noteeditor_file_request_rnto := html.Span(
                            id="noteeditor_file_request_rnto_", style={"fontStyle": "italic"}
                        ),
                    ],
                    style={
