...
modal_close = {
    ...
    "backgroundColor": config.themes.top_onoff_bg,
    "borderRadius": 25,
    "height": 50,
}
...
by_taketime_on = {
    ...
    "border": "1px solid " + config.themes.table_sep,
    "backgroundColor": config.themes.col_take,
    "backgroundImage": "",
}
by_taketime_off = by_taketime_on | {"backgroundColor": config.themes.col_invest}

by_index_off = by_taketime_on | {
    "backgroundColor": config.themes.table_bg_main,
    "backgroundImage": config.themes.top_by_index_off,
}

with_open_on = {
    "color": config.themes.table_fg_main,
    "border": "1px solid " + config.themes.table_sep,
    "backgroundColor": config.themes.record_opentrade,
}
with_open_off = by_taketime_on | {
    "color": config.themes.table_fg_header,
    "backgroundColor": config.themes.table_bg_main,
}

autosave_on = {
    "color": config.themes.top_onoff_fg,
    "border": "1px solid " + config.themes.table_sep,
    "backgroundColor": config.themes.top_onoff_bg,
}
autosave_off = {
