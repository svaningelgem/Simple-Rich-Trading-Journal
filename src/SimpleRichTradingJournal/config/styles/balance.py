...
year_cell = {"backgroundColor": config.themes.sheet_col_year}
q1_cell = {"borderRight": "1px solid " + config.themes.sheet_quarter_sep}
q4_cell = {"borderLeft": "1px solid " + config.themes.sheet_quarter_sep}

year_header = {"backgroundColor": config.themes.sheet_header_year}
q1_header = q1_cell
q4_header = q4_cell

_current_sep = {"borderRight": "1px solid " + config.themes.sheet_current_sep}
t52w_cell = _current_sep | {"backgroundColor": config.themes.sheet_col_t52}
t52w_header = _current_sep | {"backgroundColor": config.themes.sheet_header_t52}
current_cell = _current_sep | {"backgroundColor": config.themes.sheet_col_current}
current_header = _current_sep | {"backgroundColor": config.themes.sheet_header_current}

active = {"border": "unset !important", "backgroundColor": config.themes.sheet_cell_active_bg}
